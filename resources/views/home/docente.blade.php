...
<ul class="list-unstyled components">
    ...
    @endif
    <li>
        <a href="{{route('homeDocente')}}">Inicio</a>
    </li>
    <li>
    ...
    <div class="row">
        ...
        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3"
            style="color:#000;border-radius:10%; background:{{$count > 0 ? 'red' : 'none'}};">
            <span> {{$count}}</span>
        </div>
    </div>
    </a>
    ...
    <li>
        <a href="{{route('proyectos_asesor')}}">Proyectos como asesor</a>
    </li>
    <li>
        <a href="{{route('proyectos_jurado')}}">Proyectos como jurado</a>
    </li>
    <li>
